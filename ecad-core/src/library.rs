...
//!
//! A **library package** is a directory containing a manifest file named `ecad.lib`
...
//!
//! # Manifest grammar (`ecad.lib`)
//!
//! Line-based, hand-rolled — the same family as the `.ecad` grammar. `#` starts a
...
pub const MANIFEST_NAME: &str = "ecad.lib";
...
/// Load a library package from `dir`: parse `dir/ecad.lib` and build every declared
...
";
    ...
    fn missing_manifest_is_an_error() {
        ...
        assert!(err.contains("ecad.lib"), "got: {err}");
    }
