...
### Decision 22 — route identity persists: ids serialize in the state zone (2026-07-07, drafted; not yet implemented)
...
- **Decision 22 (route ids in the state zone) — drafted 2026-07-07, awaiting
  implementation**: id token in `route`/`via` lines, lenient parse, one engine
  allocator, gapped round-trip test. Resolves 0034; unblocks gw-02/gw-14/gw-20.
