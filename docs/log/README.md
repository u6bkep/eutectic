...
| [d25](d25-board-place-tool.md) | 2026-07-18 | implemented (`8a7738d`) | The board strip gains Place Part, amending d24; gw-03 is its docked palette with owned-renderer thumbnails, while schematic Place Symbol remains in the schematic-authoring campaign |
