//! review — dump the headless bundle artifacts for every `eutectic-gui` fixture.
//!
...
//! it renders through the two-frame [`harness`](eutectic_gui::harness) at a fixed
...
//! `eutectic-gui/out/` (gitignored), prints where, and exits non-zero if any
//! fixture has lint findings — so the same `main` works as a CI gate.
//!
//! Run with `cargo run -p eutectic-gui --bin review`.

use damascene_core::prelude::*;
use eutectic_gui::{fixtures, harness};
