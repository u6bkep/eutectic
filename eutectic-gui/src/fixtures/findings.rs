...
pub fn drc_violation() -> EutecticApp {
    EutecticApp::new(drc_violation_domain())
}
...
pub fn sidebar_findings_expanded() -> EutecticApp {
    use crate::app::pane::SidebarSection;
    let app = EutecticApp::new(drc_violation_domain());
...
pub fn unresolved_libs() -> EutecticApp {
    EutecticApp::new(unresolved_libs_domain())
}
...
pub fn libraries_menu() -> EutecticApp {
    let mut registry = crate::registry::Registry::new();
    registry
        .set("stale", std::path::Path::new("/nonexistent/eutectic-lib"))
