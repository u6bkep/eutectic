...
pub(crate) fn mm_pt(x: i64, y: i64) -> eutectic_core::coord::Point {
...
pub fn route_in_progress() -> EutecticApp {
    use crate::tool::Tool;
...
pub fn routed_trace() -> EutecticApp {
    use eutectic_core::id::EntityId;
...
pub fn route_layer_switch() -> EutecticApp {
    use crate::tool::Tool;
    use eutectic_core::id::EntityId;
    let app = EutecticApp::new(edit_board_domain());
    app.set_tool(crate::app::ViewKind::Board, Tool::Route);
...
pub fn trace_vertex_drag() -> EutecticApp {
